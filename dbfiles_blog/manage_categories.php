...
if(isset($_POST['insert'])) {
	...
	$query = "INSERT into `categories` values ('0', '$category', '$type', '$body', '$subject')";
	$dbc->query($query);
...
<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
	...
	Category type:<input type="text" name="name" size="30"><br>
	Category Article:<input type="text" name="body" size="50"><br>
	Sub category:<input type="text" name="subject" size="30"><br>
